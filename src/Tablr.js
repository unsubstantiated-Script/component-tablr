...
import styles from "./stories/Tablr.module.css";
import PropTypes from "prop-types";

export const Tablr = ({
	// setting defaults here when using =
	rows,
	headers,
	borderWidth = "medium",
	cellPadding = "medium",
	...
	//These are gonna store all of our style variants
...
Tablr.propTypes = {
	...
	// Double array structure to list PropTypes
